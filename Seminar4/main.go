...
func main() {
	...
	if err != nil {
		fmt.Println("Ошибка при разборе URL сервера:", err)
		return
	}
	...
	if err != nil {
		fmt.Println("Ошибка при создании дружбы:", err)
		return
	}
	...
	if err != nil {
		fmt.Println("Ошибка при получении друзей пользователя:", err)
		return
	}
	...
	if err != nil {
		fmt.Println("Ошибка при обновлении возраста пользователя:", err)
		return
	}
